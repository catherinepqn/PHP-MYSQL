...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="./"><span class="glyphicons glyphicons-skull"></span>IT461 Assignment Page</a>
    </div>
	<!--Start of the list -->
		 ...
		 <!-- In Class Assignments -->
		  <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">In Class Assignments <span class="caret"></span></a>
			<ul class="dropdown-menu">
				...
				<li><a href="./In Class/DeliveryForm.php">Form Skill</a><li>
		  ...
		  <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Skill Practice <span class="caret"></span></a>
			<ul class="dropdown-menu">
				<li><a href="./Skill Test/Form1.php">Form #1</a></li>
				<li><a href="./Skill Test/Form2.php">Form #2</a></li>
				<li><a href="./Skill Test/PHPValidate1.php">PHP Validate #1</a></li>
				<li><a href="./Skill Test/PHPValidate2.php">PHP Validate #2</a></li>
				<li><a href="./Skill Test/MYSQL.php">PHP and MYSQL #1</a></li>
				<li><a href="./Skill Test/MYSQL2.php">PHP and MYSQL #2</a></li>
				<li><a href="./Skill Test/MYSQL3.php">PHP and MYSQL #3</a></li>
			</ul>
